              ...
              child: _isLoading
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Text('Company logo', style: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 12)),
                    ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Dark mode', style: TextStyle(color: Colors.white.withValues(alpha: 0.8), fontSize: 13)),
                        Switch(
                          value: _darkModeOn,
                          activeThumbColor: kAuthAccentMint,
                    ...
                    const SizedBox(height: 22),
                    Text('COMPANY DETAILS', style: TextStyle(color: Colors.white.withValues(alpha: 0.5), fontSize: 11, letterSpacing: 1)),
